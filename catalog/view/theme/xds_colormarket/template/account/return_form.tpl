...
<div id="content" class="return-content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" class="large-field date" /><br /><br />
    ...
    <div id="return-product">
      <div class="content">
        ...
        <div class="return-detail">
          <div class="return-reason"><span class="required">*</span> <b><?php echo $entry_reason; ?></b><br /><br />
            <table>
          ...
          <div class="return-opened"><b><?php echo $entry_opened; ?></b> 
            <?php if ($opened) { ?>
