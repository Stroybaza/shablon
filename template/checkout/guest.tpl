...
<div class="right">
    ...
    <select name="country_id" class="large-field">
        ...
        <?php } else { ?>
        <option value="<?php echo $country['country_id']; ?>" data-iso2="<?php echo $country['iso_code_2']; ?>"><?php echo $country['name']; ?>
        </option>
        <?php } ?>
        <?php } ?>
    </select>
...
<div id="shipping_checkbox" style="clear: both; padding-top: 15px; border-top: 1px solid #DDDDDD;">
