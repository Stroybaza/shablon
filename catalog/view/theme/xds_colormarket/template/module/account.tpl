<div class="box" >
  ...
  <div class="box-content" style="background: #f0f8fc;">
    <ul class="list_module_account">
      <?php if (!$logged) { ?>
      <li>
				<a class="login" href="<?php echo $login; ?>"><?php echo $text_login; ?></a>
			</li>
			<li>
				<a class="register" href="<?php echo $register; ?>"><?php echo $text_register; ?></a>
      </li>
			<li>
      ...
      <?php if ($logged) { ?>
      <li>
				<a class="logout" href="<?php echo $logout; ?>"><?php echo $text_logout; ?></a>
			</li>
      <?php } ?>
    </ul>
  </div>
