...
<!--//kogan +-->
        ...
        <?php } ?>
        <span><?php echo $text_stock; ?></span> <b><?php echo $stock; ?></b>
			</div>
      <?php if ($price) { ?>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/xds_colormarket/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <textarea name="text" cols="40" rows="8" style="width: 90%;"></textarea><br />
  ...
  <div id="tab-related" class="tab-content">
    <div class="box-product">
      ...
      <div>
        ...
        <div class="rating"><img src="catalog/view/theme/xds_colormarket/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
        <?php } ?>
