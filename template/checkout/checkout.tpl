...
<div class="left">
    <table class="form">
        ...
        <tr>
            ...
            <td>
                <select name="country_id" id='mycid' class="large-field">
...
<div class="right">
    <div id='mydiv1' class="shipping-content" style="display: block">
        ...
        <table class="form">
            ...
            <tr>
                ...
                <td style="text-align: right;color:mediumvioletred;font-weight: bold; font-size: 12px;">
...
<script type="text/javascript"><!--
    ...
    $('#checkout_form select[name=\'zone_id\']').bind('change', function() {
            $.ajax({
                url: 'index.php?route=checkout/shipping_method&zone_id=' + this.value + '&country_id=' + $('#mycid').value,
                data: 'zone_id='+this.value+ '&country_id=252',
                dataType: 'html',
    ...
    $('#checkout_form select[name=\'country_id\']').bind('change', function() {
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                $('#checkout_form select[name=\'zone_id\']').trigger('change');
