<?php echo $header; ?>
<?php if ($success) { ?>
<div class="success"><?php echo $success; ?><img src="catalog/view/theme/xds_colormarket/image/close.png" alt="" class="close" /></div>
<?php } ?>
